...
fastify.all("/twiml", async (request, reply) => {
  reply.type("text/xml").send(
    ...
    <Response>
      <Connect>
        <ConversationRelay url="${WS_URL}" ttsProvider="ElevenLabs"  input="speech"    voice="ZF6FPAbjXT4488VcRRnw-flash_v2_5-1.2_1.0_1.0" elevenlabsTextNormalization="on" welcomeGreeting="${WELCOME_GREETING}" />
      </Connect>
    </Response>`
  );
});
